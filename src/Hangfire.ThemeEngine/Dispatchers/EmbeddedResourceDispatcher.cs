...
{
    /// <summary>
    /// It is a hangfire dispatcher for some reason it is not public
    /// Source : https://github.com/pieceofsummer/Hangfire.Console/blob/master/src/Hangfire.Console/Support/EmbeddedResourceDispatcher.cs
    /// </summary>
